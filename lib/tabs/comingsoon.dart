      ...
      body: ListView(
        children: <Widget>[
          itemCont(
              ...
              'assets/images/obli.jpg',
              'Sci-fi • Future • Cyborgs & Robots • Cyberpunk'),
          itemCont(
              context,
              'Our Planet',
              'Coming 25 April',
              ...
              'assets/images/ourplanet.jpg',
              'Documentary • BBC • Planet Earth • Nature'),
          itemCont(
              context,
              ...
              'Horror • Half-Witch • Magic'),
        ],
      ),
    );
  }

  Container itemCont(BuildContext context, String name, String arriving,
      String desp, String image, String tags) {
    return Container(
